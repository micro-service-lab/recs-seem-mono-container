...
ALTER TABLE t_chat_room_remove_member_actions ADD CONSTRAINT fk_t_chat_room_remove_member_actions_chat_room_action_id FOREIGN KEY (chat_room_action_id) REFERENCES t_chat_room_actions(chat_room_action_id) ON DELETE CASCADE ON UPDATE CASCADE;

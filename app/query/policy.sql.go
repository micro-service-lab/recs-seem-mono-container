...
AND
	CASE $6
		WHEN 'next' THEN
			CASE $7::text
				WHEN 'name' THEN m_policies.name > $8 OR (m_policies.name = $8 AND m_policies_pkey < $9)
				WHEN 'r_name' THEN m_policies.name < $8 OR (m_policies.name = $8 AND m_policies_pkey < $9)
				ELSE m_policies_pkey < $9
			END
		WHEN 'prev' THEN
			CASE $7::text
				WHEN 'name' THEN m_policies.name < $8 OR (m_policies.name = $8 AND m_policies_pkey > $9)

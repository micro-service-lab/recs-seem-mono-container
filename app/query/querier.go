...
type Querier interface {
	...
	GetReadableMessagesOnChatRoomAndMember(ctx context.Context, arg GetReadableMessagesOnChatRoomAndMemberParams) ([]GetReadableMessagesOnChatRoomAndMemberRow, error)
	GetReadableMessagesOnChatRoomAndMemberUseKeysetPaginate(ctx context.Context, arg GetReadableMessagesOnChatRoomAndMemberUseKeysetPaginateParams) ([]GetReadableMessagesOnChatRoomAndMemberUseKeysetPaginateRow, error)
	GetReadableMessagesOnChatRoomAndMemberUseNumberedPaginate(ctx context.Context, arg GetReadableMessagesOnChatRoomAndMemberUseNumberedPaginateParams) ([]GetReadableMessagesOnChatRoomAndMemberUseNumberedPaginateRow, error)

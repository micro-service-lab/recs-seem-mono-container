...
type Querier interface {
	...
	CountAttachedItemsOnChatRoom(ctx context.Context, chatRoomID uuid.UUID) (int64, error)
	CountAttachedItemsOnMessage(ctx context.Context, messageID uuid.UUID) (int64, error)
	...
	GetAttachedItemsOnChatRoom(ctx context.Context, chatRoomID uuid.UUID) ([]GetAttachedItemsOnChatRoomRow, error)
	...
	GetAttachedItemsOnMessage(ctx context.Context, messageID uuid.UUID) ([]GetAttachedItemsOnMessageRow, error)
	...
	GetAttachedItemsOnMessageWithMimeType(ctx context.Context, messageID uuid.UUID) ([]GetAttachedItemsOnMessageWithMimeTypeRow, error)
	...
	GetPluralAttachedItemsOnChatRoom(ctx context.Context, chatRoomIds []uuid.UUID) ([]GetPluralAttachedItemsOnChatRoomRow, error)
	GetPluralAttachedItemsOnChatRoomUseNumberedPaginate(ctx context.Context, arg GetPluralAttachedItemsOnChatRoomUseNumberedPaginateParams) ([]GetPluralAttachedItemsOnChatRoomUseNumberedPaginateRow, error)
	...
	GetPluralAttendStatuses(ctx context.Context, attendStatusIds []uuid.UUID) ([]AttendStatus, error)
	...
	GetPluralAttendanceTypes(ctx context.Context, attendanceTypeIds []uuid.UUID) ([]AttendanceType, error)
	...
	GetPluralAttendanceWithAll(ctx context.Context, attendanceIds []uuid.UUID) ([]GetPluralAttendanceWithAllRow, error)
	...
	GetPluralAttendanceWithAttendanceType(ctx context.Context, attendanceIds []uuid.UUID) ([]GetPluralAttendanceWithAttendanceTypeRow, error)
	...
	GetPluralAttendanceWithDetails(ctx context.Context, attendanceIds []uuid.UUID) ([]GetPluralAttendanceWithDetailsRow, error)
	...
	GetPluralAttendanceWithMember(ctx context.Context, attendanceIds []uuid.UUID) ([]GetPluralAttendanceWithMemberRow, error)
	...
	GetPluralAttendanceWithSendOrganization(ctx context.Context, attendanceIds []uuid.UUID) ([]GetPluralAttendanceWithSendOrganizationRow, error)
	...
	GetPluralAttendances(ctx context.Context, attendanceIds []uuid.UUID) ([]Attendance, error)
	...
	GetPluralChatRoomsOnMember(ctx context.Context, memberIds []uuid.UUID) ([]GetPluralChatRoomsOnMemberRow, error)
	...
	GetPluralEventTypes(ctx context.Context, eventTypeIds []uuid.UUID) ([]EventType, error)
	...
	GetPluralEvents(ctx context.Context, eventIds []uuid.UUID) ([]Event, error)
	GetPluralEventsUseNumberedPaginate(ctx context.Context, arg GetPluralEventsUseNumberedPaginateParams) ([]Event, error)
	GetPluralEventsWithAll(ctx context.Context, eventIds []uuid.UUID) ([]GetPluralEventsWithAllRow, error)
	...
	GetPluralEventsWithLastEditUser(ctx context.Context, eventIds []uuid.UUID) ([]GetPluralEventsWithLastEditUserRow, error)
	...
	GetPluralEventsWithOrganization(ctx context.Context, eventIds []uuid.UUID) ([]GetPluralEventsWithOrganizationRow, error)
	...
	GetPluralEventsWithPostUser(ctx context.Context, eventIds []uuid.UUID) ([]GetPluralEventsWithPostUserRow, error)
	...
	GetPluralEventsWithSendOrganization(ctx context.Context, eventIds []uuid.UUID) ([]GetPluralEventsWithSendOrganizationRow, error)
	...
	GetPluralEventsWithType(ctx context.Context, eventIds []uuid.UUID) ([]GetPluralEventsWithTypeRow, error)
	...
	GetPluralFiles(ctx context.Context, attachableItemIds []uuid.UUID) ([]File, error)
	GetPluralFilesUseNumberedPaginate(ctx context.Context, arg GetPluralFilesUseNumberedPaginateParams) ([]File, error)
	GetPluralFilesWithAttachableItem(ctx context.Context, attachableItemIds []uuid.UUID) ([]GetPluralFilesWithAttachableItemRow, error)
	...
	GetPluralGrades(ctx context.Context, organizationIds []uuid.UUID) ([]Grade, error)
	GetPluralGradesUseNumberedPaginate(ctx context.Context, arg GetPluralGradesUseNumberedPaginateParams) ([]Grade, error)
	GetPluralGradesWithOrganization(ctx context.Context, organizationIds []uuid.UUID) ([]GetPluralGradesWithOrganizationRow, error)
	...
	GetPluralGroups(ctx context.Context, organizationIds []uuid.UUID) ([]Group, error)
	...
	GetPluralImages(ctx context.Context, attachableItemIds []uuid.UUID) ([]Image, error)
	GetPluralImagesUseNumberedPaginate(ctx context.Context, arg GetPluralImagesUseNumberedPaginateParams) ([]Image, error)
	GetPluralImagesWithAttachableItem(ctx context.Context, attachableItemIds []uuid.UUID) ([]GetPluralImagesWithAttachableItemRow, error)
	...
	GetPluralLabIOHistories(ctx context.Context, labIoHistoryIds []uuid.UUID) ([]LabIOHistory, error)
	...
	GetPluralLabIOHistoriesWithMember(ctx context.Context, labIoHistoryIds []uuid.UUID) ([]GetPluralLabIOHistoriesWithMemberRow, error)
	...
	GetPluralMembers(ctx context.Context, memberIds []uuid.UUID) ([]Member, error)
	GetPluralMembersOnChatRoom(ctx context.Context, chatRoomIds []uuid.UUID) ([]GetPluralMembersOnChatRoomRow, error)
	...
	GetPluralMembersWithAll(ctx context.Context, memberIds []uuid.UUID) ([]GetPluralMembersWithAllRow, error)
	GetPluralMembersWithAllUseNumberedPaginate(ctx context.Context, arg GetPluralMembersWithAllUseNumberedPaginateParams) ([]GetPluralMembersWithAllUseNumberedPaginateRow, error)
	GetPluralMembersWithAttendStatus(ctx context.Context, memberIds []uuid.UUID) ([]GetPluralMembersWithAttendStatusRow, error)
	...
	GetPluralMembersWithGrade(ctx context.Context, memberIds []uuid.UUID) ([]GetPluralMembersWithGradeRow, error)
	GetPluralMembersWithGradeUseNumberedPaginate(ctx context.Context, arg GetPluralMembersWithGradeUseNumberedPaginateParams) ([]GetPluralMembersWithGradeUseNumberedPaginateRow, error)
	GetPluralMembersWithGroup(ctx context.Context, memberIds []uuid.UUID) ([]GetPluralMembersWithGroupRow, error)
	GetPluralMembersWithGroupUseNumberedPaginate(ctx context.Context, arg GetPluralMembersWithGroupUseNumberedPaginateParams) ([]GetPluralMembersWithGroupUseNumberedPaginateRow, error)
	GetPluralMembersWithPersonalOrganization(ctx context.Context, memberIds []uuid.UUID) ([]GetPluralMembersWithPersonalOrganizationRow, error)
	...
	GetPluralMembersWithRole(ctx context.Context, memberIds []uuid.UUID) ([]GetPluralMembersWithRoleRow, error)
	...
	GetPluralMessages(ctx context.Context, messageIds []uuid.UUID) ([]Message, error)
	GetPluralMessagesUseNumberedPaginate(ctx context.Context, arg GetPluralMessagesUseNumberedPaginateParams) ([]Message, error)
	GetPluralMessagesWithAll(ctx context.Context, messageIds []uuid.UUID) ([]GetPluralMessagesWithAllRow, error)
	GetPluralMessagesWithAllUseNumberedPaginate(ctx context.Context, arg GetPluralMessagesWithAllUseNumberedPaginateParams) ([]GetPluralMessagesWithAllUseNumberedPaginateRow, error)
	GetPluralMessagesWithChatRoom(ctx context.Context, messageIds []uuid.UUID) ([]GetPluralMessagesWithChatRoomRow, error)
	...
	GetPluralMessagesWithSender(ctx context.Context, messageIds []uuid.UUID) ([]GetPluralMessagesWithSenderRow, error)
	...
	GetPluralMimeTypes(ctx context.Context, mimeTypeIds []uuid.UUID) ([]MimeType, error)
	GetPluralMimeTypesUseNumberedPaginate(ctx context.Context, arg GetPluralMimeTypesUseNumberedPaginateParams) ([]MimeType, error)
	GetPluralOrganizations(ctx context.Context, organizationIds []uuid.UUID) ([]Organization, error)
	...
	GetPluralOrganizationsWithAll(ctx context.Context, organizationIds []uuid.UUID) ([]GetPluralOrganizationsWithAllRow, error)
	GetPluralOrganizationsWithAllUseNumberedPaginate(ctx context.Context, arg GetPluralOrganizationsWithAllUseNumberedPaginateParams) ([]GetPluralOrganizationsWithAllUseNumberedPaginateRow, error)
	GetPluralOrganizationsWithChatRoom(ctx context.Context, organizationIds []uuid.UUID) ([]GetPluralOrganizationsWithChatRoomRow, error)
	...
	GetPluralOrganizationsWithDetail(ctx context.Context, organizationIds []uuid.UUID) ([]GetPluralOrganizationsWithDetailRow, error)
	...
	GetPluralPermissionCategories(ctx context.Context, permissionCategoryIds []uuid.UUID) ([]PermissionCategory, error)
	...
	GetPluralPermissions(ctx context.Context, permissionIds []uuid.UUID) ([]Permission, error)
	GetPluralPermissionsOnWorkPosition(ctx context.Context, workPositionIds []uuid.UUID) ([]GetPluralPermissionsOnWorkPositionRow, error)
	...
	GetPluralPermissionsWithCategory(ctx context.Context, permissionIds []uuid.UUID) ([]GetPluralPermissionsWithCategoryRow, error)
	...
	GetPluralPolicies(ctx context.Context, policyIds []uuid.UUID) ([]Policy, error)
	GetPluralPoliciesOnRole(ctx context.Context, roleIds []uuid.UUID) ([]GetPluralPoliciesOnRoleRow, error)
	...
	GetPluralPoliciesWithCategory(ctx context.Context, policyIds []uuid.UUID) ([]GetPluralPoliciesWithCategoryRow, error)
	...
	GetPluralPolicyCategories(ctx context.Context, policyCategoryIds []uuid.UUID) ([]PolicyCategory, error)
	...
	GetPluralPositionHistories(ctx context.Context, positionHistoryIds []uuid.UUID) ([]PositionHistory, error)
	...
	GetPluralPositionHistoriesWithMember(ctx context.Context, positionHistoryIds []uuid.UUID) ([]GetPluralPositionHistoriesWithMemberRow, error)
	...
	GetPluralProfessors(ctx context.Context, memberIds []uuid.UUID) ([]Professor, error)
	...
	GetPluralRecordTypes(ctx context.Context, recordTypeIds []uuid.UUID) ([]RecordType, error)
	...
	GetPluralRecords(ctx context.Context, recordIds []uuid.UUID) ([]Record, error)
	GetPluralRecordsUseNumberedPaginate(ctx context.Context, arg GetPluralRecordsUseNumberedPaginateParams) ([]Record, error)
	GetPluralRecordsWithAll(ctx context.Context, recordIds []uuid.UUID) ([]GetPluralRecordsWithAllRow, error)
	...
	GetPluralRecordsWithLastEditedBy(ctx context.Context, recordIds []uuid.UUID) ([]GetPluralRecordsWithLastEditedByRow, error)
	...
	GetPluralRecordsWithOrganization(ctx context.Context, recordIds []uuid.UUID) ([]GetPluralRecordsWithOrganizationRow, error)
	...
	GetPluralRecordsWithPostedBy(ctx context.Context, recordIds []uuid.UUID) ([]GetPluralRecordsWithPostedByRow, error)
	...
	GetPluralRecordsWithRecordType(ctx context.Context, recordIds []uuid.UUID) ([]GetPluralRecordsWithRecordTypeRow, error)
	...
	GetPluralRoles(ctx context.Context, roleIds []uuid.UUID) ([]Role, error)
	GetPluralRolesOnPolicy(ctx context.Context, policyIds []uuid.UUID) ([]GetPluralRolesOnPolicyRow, error)
	...
	GetPluralStudents(ctx context.Context, memberIds []uuid.UUID) ([]Student, error)
	GetPluralStudentsUseNumberedPaginate(ctx context.Context, arg GetPluralStudentsUseNumberedPaginateParams) ([]Student, error)
	GetPluralWorkPositions(ctx context.Context, workPositionIds []uuid.UUID) ([]GetPluralWorkPositionsRow, error)
	GetPluralWorkPositionsOnPermission(ctx context.Context, permissionIds []uuid.UUID) ([]GetPluralWorkPositionsOnPermissionRow, error)

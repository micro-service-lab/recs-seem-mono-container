...
UPDATE t_records SET record_type_id = $2, title = $3, body = $4, organization_id = $5, posted_by = $6, last_edited_by = $7, posted_at = $8, last_edited_at = $9 WHERE record_id = $1 RETURNING *;

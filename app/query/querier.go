...
type Querier interface {
	...
	CountAttachableItemsOnMessage(ctx context.Context, messageID uuid.UUID) (int64, error)
	...
	GetAttachableItemsOnMessage(ctx context.Context, arg GetAttachableItemsOnMessageParams) ([]GetAttachableItemsOnMessageRow, error)
	GetAttachedMessagesOnChatRoom(ctx context.Context, arg GetAttachedMessagesOnChatRoomParams) ([]GetAttachedMessagesOnChatRoomRow, error)

...
ALTER TABLE t_attached_messages ADD CONSTRAINT fk_t_attached_messages_message_id FOREIGN KEY (message_id) REFERENCES t_messages(message_id) ON DELETE RESTRICT ON UPDATE RESTRICT;

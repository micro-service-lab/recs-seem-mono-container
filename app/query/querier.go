...
type Querier interface {
	...
	CountFilesOnMessage(ctx context.Context, messageID uuid.UUID) (int64, error)
	...
	GetFilesOnMessage(ctx context.Context, messageID uuid.UUID) ([]GetFilesOnMessageRow, error)
	...
	GetPluralFilesOnChatRoom(ctx context.Context, chatRoomIds []uuid.UUID) ([]GetPluralFilesOnChatRoomRow, error)
	GetPluralFilesOnChatRoomUseNumberedPaginate(ctx context.Context, arg GetPluralFilesOnChatRoomUseNumberedPaginateParams) ([]GetPluralFilesOnChatRoomUseNumberedPaginateRow, error)
	GetPluralFilesOnMessage(ctx context.Context, messageIds []uuid.UUID) ([]GetPluralFilesOnMessageRow, error)
	GetPluralFilesOnMessageUseNumberedPaginate(ctx context.Context, arg GetPluralFilesOnMessageUseNumberedPaginateParams) ([]GetPluralFilesOnMessageUseNumberedPaginateRow, error)

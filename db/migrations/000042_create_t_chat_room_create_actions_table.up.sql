...
ALTER TABLE t_chat_room_create_actions ADD CONSTRAINT fk_t_chat_room_create_actions_chat_room_action_id FOREIGN KEY (chat_room_action_id) REFERENCES t_chat_room_actions(chat_room_action_id) ON DELETE RESTRICT ON UPDATE RESTRICT;

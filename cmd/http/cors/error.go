...
// As implements the As method of the error interface.
func (e *PreflightNotOriginAllowedError) As(target any) bool {
	switch target.(type) {
...
// As implements the As method of the error interface.
func (e *PreflightEmptyOriginError) As(target any) bool {
	switch target.(type) {
...
// As implements the As method of the error interface.
func (e *PreflightNotAllowedMethodError) As(target any) bool {
	switch target.(type) {
...
// As implements the As method of the error interface.
func (e *PreflightNotHeadersAllowedError) As(target any) bool {
	switch target.(type) {
...
// As implements the As method of the error interface.
func (e *ActualMissingOriginError) As(target any) bool {
	switch target.(type) {
...
// As implements the As method of the error interface.
func (e *ActualOriginNotAllowedError) As(target any) bool {
	switch target.(type) {
...
// As implements the As method of the error interface.
func (e *ActualMethodNotAllowedError) As(target any) bool {
	switch target.(type) {
